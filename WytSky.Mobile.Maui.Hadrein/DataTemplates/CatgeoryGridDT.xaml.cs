...
public partial class CatgeoryGridDT : ContentView
{
    public CatgeoryGridDT()
    {
        InitializeComponent();
    }
    ...
    BindableProperty.Create(nameof(ModelData),
        typeof(StCatgeory), typeof(CatgeoryGridDT), default, BindingMode.TwoWay);
    ...
    BindableProperty.Create(nameof(TapCommand),
        typeof(ICommand), typeof(CatgeoryGridDT),
    ...
    BindableProperty.Create(nameof(ImageAspect),
        typeof(Aspect), typeof(CatgeoryGridDT),
    ...
    BindableProperty.Create(nameof(IsVisibleTime),
        typeof(bool), typeof(CatgeoryGridDT),
