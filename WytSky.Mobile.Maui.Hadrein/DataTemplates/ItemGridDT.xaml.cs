...
public partial class ItemGridDT : ContentView
{
    public ItemGridDT()
    {
        InitializeComponent();
    ...
    BindableProperty.Create(nameof(ModelData),
        typeof(StItem), typeof(ItemGridDT), default, BindingMode.TwoWay);
    ...
    BindableProperty.Create(nameof(IncreaseQuantityCommand),
        typeof(ICommand), typeof(ItemGridDT),
    ...
    BindableProperty.Create(nameof(ImageAspect),
        typeof(Aspect), typeof(ItemGridDT),
